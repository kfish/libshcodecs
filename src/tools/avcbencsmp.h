...
int encode_1file(long case_no, APPLI_INFO *appli_info, long stream_type);
...
void cat_output_stream(APPLI_INFO *appli_info, avcbe_stream_info *context, char *frame_stream_address, long frame_stream_size);
...
int load_1frame_from_image_file(APPLI_INFO *appli_info, unsigned long *addr_y, unsigned long *addr_c);
