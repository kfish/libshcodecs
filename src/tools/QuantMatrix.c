...
//	m4vse_quant_type1_matrix quant_type1_matrix;
	...
	case QMAT_MPEG_TYPE_DEFAULT_INTRA:
		matrix_ptr = (char *)&Qmat_for_Intra_MPEG4_quanttype1_default[0];
		break;
	...
	case QMAT_MPEG_TYPE_SPECIAL_INTRA:
		matrix_ptr = (char *)&Qmat_for_Intra_MPEG4_maruo_special1[0];
		break;
	default:
		return_code = -1;
		break;
	...
	for (index=0; index < 64; index++) {
		quant_type1_matrix.avcbe_intra_qmatrix[index] = (char)*matrix_ptr++;
//		quant_type1_matrix.m4vse_intra_qmatrix[index] = (char)*matrix_ptr++;
	...
	case QMAT_MPEG_TYPE_DEFAULT_NONINTRA:
		matrix_ptr = (char *)&Qmat_for_NonIntra_MPEG4_quanttype1_default[0];
		break;
	...
	case QMAT_MPEG_TYPE_SPECIAL_NONINTRA:
		matrix_ptr = (char *)&Qmat_for_NonIntra_MPEG4_maruo_special1[0];
		break;
	default:
		return_code = -1;
		break;
	...
	for (index=0; index < 64; index++) {
		quant_type1_matrix.avcbe_inter_qmatrix[index] = (char)*matrix_ptr++;
