...
/*----------------------------------------------------------------------------------------------*/
unsigned long m4iph_sdr_read_vpu4(unsigned char *address, unsigned char *buffer, unsigned long count)
{
...
/* (This function is common to MPEG-4&H.264 Encoder for VPU4.)  */
/*----------------------------------------------------------------------------------------------*/
void m4iph_sdr_write_vpu4(unsigned char *address, unsigned char *buffer, unsigned long count)
{
 ...
 * became over follow. */
/*-----------------------------------------------------------------------------*/
unsigned long avcbe_insert_filler_data_for_cpb_buffer(unsigned long input_filler_size)
{
	if (ainfo.output_filler_enable == 1) {
		...
		/* Input Filler Data */
		ainfo.output_filler_data = avcbe_put_filler_data(&my_filler_data_buff_info, AVCBE_ON, input_filler_size);
	}else{
...
{        
	...
	for(loop_index=0; loop_index < (MY_STREAM_BUFF_SIZE/4); loop_index++){
	...
	success_count = 0;
	for (loop_index=CASE0_MPEG4_001; loop_index <= CASE3_H264_003; loop_index++) {   
...
int select_inputfile_set_param(long case_no, APPLI_INFO *appli_info)	/* add case_no at Version2 */
{
	...
	return_code = GetFromCtrlFtoEncParam(appli_info->ctrl_file_name_buf, &appli_info->enc_exec_info,
					&appli_info->param, &appli_info->other_options_h264, &appli_info->other_options_mpeg4);
	if (return_code == -1) {
...
//	appli_info->input_file_name_buf[0] = '\0';
	...
	appli_info->other_API_enc_param.out_dec_ref_pic_marking_repetition_SEI = 0;

	memset(&(appli_info->other_API_enc_param.sei_buffering_period_param), 0,
	...
	memset(&(appli_info->other_API_enc_param.sei_pan_scan_rect_param), 0,
		   	sizeof(avcbe_sei_pan_scan_rect_param));
	memset(&(appli_info->other_API_enc_param.sei_filler_payload_param), 0, 
			sizeof(avcbe_sei_filler_payload_param));
	memset(&(appli_info->other_API_enc_param.sei_recovery_point_param), 0, 
			sizeof(avcbe_sei_recovery_point_param));
...
//21		appli_info->param.avcbe_weightedQ_mode = AVCBE_WEIGHTEDQ_NONE;
	...
	if ((appli_info->param.avcbe_stream_type == AVCBE_MPEG4)||
		...
		case CASE0_MPEG4_001:
			...
			appli_info->other_options_mpeg4.avcbe_out_vos = AVCBE_ON;
			appli_info->other_options_mpeg4.avcbe_out_gov = AVCBE_ON;
			appli_info->other_options_mpeg4.avcbe_aspect_ratio_info_type = AVCBE_AUTO;
			appli_info->other_options_mpeg4.avcbe_aspect_ratio_info_value = 3;

			appli_info->other_options_mpeg4.avcbe_vos_profile_level_type = AVCBE_AUTO;
			appli_info->other_options_mpeg4.avcbe_vos_profile_level_value = 1;
			appli_info->other_options_mpeg4.avcbe_out_visual_object_identifier = AVCBE_OFF;
			appli_info->other_options_mpeg4.avcbe_visual_object_verid = 0;
			appli_info->other_options_mpeg4.avcbe_visual_object_priority = 7;
			appli_info->other_options_mpeg4.avcbe_video_object_type_indication = 0;
			appli_info->other_options_mpeg4.avcbe_out_object_layer_identifier = AVCBE_OFF;
			appli_info->other_options_mpeg4.avcbe_video_object_layer_verid = 0;
			appli_info->other_options_mpeg4.avcbe_video_object_layer_priority = 7;

			/* 'AVCBE_ERM_VIDEO_PACKET' -> 'AVCBE_ERM_NORMAL' changed at Version2 */
			appli_info->other_options_mpeg4.avcbe_error_resilience_mode = 
													AVCBE_ERM_NORMAL; 
			appli_info->other_options_mpeg4.avcbe_video_packet_size_mb = 0;
			appli_info->other_options_mpeg4.avcbe_video_packet_size_bit = 0;
			appli_info->other_options_mpeg4.avcbe_video_packet_header_extention = AVCBE_OFF;
			 /* 'AVCBE_ON' -> 'AVCBE_OFF' changed at Version2 */
			appli_info->other_options_mpeg4.avcbe_data_partitioned = AVCBE_OFF;	
			appli_info->other_options_mpeg4.avcbe_reversible_vlc = AVCBE_OFF;

			appli_info->other_options_mpeg4.avcbe_high_quality = AVCBE_HQ_QUALITY;
			appli_info->other_options_mpeg4.avcbe_param_changeable = AVCBE_OFF;
			appli_info->other_options_mpeg4.avcbe_changeable_max_bitrate = 0;
			appli_info->other_options_mpeg4.avcbe_Ivop_quant_initial_value = 16;
			appli_info->other_options_mpeg4.avcbe_Pvop_quant_initial_value = 16;
			appli_info->other_options_mpeg4.avcbe_use_dquant = AVCBE_ON;
			/* '10' -> '4' changed at Version2 */
			appli_info->other_options_mpeg4.avcbe_clip_dquant_frame = 4;
			appli_info->other_options_mpeg4.avcbe_quant_min = 6;
			/* added at Version2 */
			appli_info->other_options_mpeg4.avcbe_quant_min_Ivop_under_range = 2;		
			...
			appli_info->other_options_mpeg4.avcbe_quant_type = AVCBE_QUANTISATION_TYPE_2;
			appli_info->other_options_mpeg4.avcbe_use_AC_prediction = AVCBE_ON;
			appli_info->other_options_mpeg4.avcbe_vop_min_mode = AVCBE_MANUAL;				/* added at Version2 */
			appli_info->other_options_mpeg4.avcbe_vop_min_size = 0;
			appli_info->other_options_mpeg4.avcbe_intra_thr = 6000;
			appli_info->other_options_mpeg4.avcbe_b_vop_num = 0;
#endif
			break;
...
//								AVCBE_I_PIC;
			...
			if (case_no == CASE1_H264_001) {
				appli_info->other_options_h264.avcbe_call_unit =
				   				AVCBE_CALL_PER_PIC;
				appli_info->other_options_h264.avcbe_use_slice = AVCBE_OFF;
				appli_info->other_options_h264.avcbe_slice_size_mb = 0;
				appli_info->other_options_h264.avcbe_slice_size_bit = 0;
			} else if (case_no == CASE2_H264_002) {
				appli_info->other_options_h264.avcbe_call_unit =
				   				AVCBE_CALL_PER_PIC;
				appli_info->other_options_h264.avcbe_use_slice = AVCBE_ON;
				appli_info->other_options_h264.avcbe_slice_size_mb = 100;
				appli_info->other_options_h264.avcbe_slice_size_bit = 0;
...
/*----- avcbe_encoding_property (common parameter for MPEG-4 & H.264) -----*/
	...
	printf("(14) ratecontrol_intra_thr_changeable = %d\n", 
				(int)appli_info->param.avcbe_ratecontrol_intra_thr_changeable);
	...
	printf("(16) intra_macroblock_refresh_cycle   = %d\n", 
				(int)appli_info->param.avcbe_intra_macroblock_refresh_cycle);
...
/*----- avcbe_other_options_h264 (H.264 Only) -----*/
	printf("(01) Ivop_quant_initial_value                  = %d\n", 
			(int)appli_info->other_options_h264.avcbe_Ivop_quant_initial_value);
	printf("(02) Pvop_quant_initial_value                  = %d\n", 
			(int)appli_info->other_options_h264.avcbe_Pvop_quant_initial_value);
	printf("(03) use_dquant   = %d\n", (int)appli_info->other_options_h264.avcbe_use_dquant);
	printf("(04) clip_dquant_next_mb                       = %d\n", 
			(int)appli_info->other_options_h264.avcbe_clip_dquant_next_mb);
	printf("(05) clip_dquant_frame                         = %d\n", 
			(int)appli_info->other_options_h264.avcbe_clip_dquant_frame);
	printf("(06) quant_min                                 = %d\n", 
			(int)appli_info->other_options_h264.avcbe_quant_min);
	printf("(07) Ivop_under_range                          = %d\n", 
			(int)appli_info->other_options_h264.avcbe_quant_min_Ivop_under_range);
	printf("(08) quant_max                                 = %d\n", 
			(int)appli_info->other_options_h264.avcbe_quant_max);

	printf("(09) ratecontrol_cpb_skipcheck_enable          = %d\n", 
			(int)appli_info->other_options_h264.avcbe_ratecontrol_cpb_skipcheck_enable);
	printf("(10) ratecontrol_cpb_Ivop_noskip               = %d\n", 
			(int)appli_info->other_options_h264.avcbe_ratecontrol_cpb_Ivop_noskip);
	printf("(11) ratecontrol_cpb_remain_zero_skip_enable   = %d\n", 
			(int)appli_info->other_options_h264.avcbe_ratecontrol_cpb_remain_zero_skip_enable);

	printf("(12) ratecontrol_cpb_buffer_unit_size          = %d\n", 
			(int)appli_info->other_options_h264.avcbe_ratecontrol_cpb_buffer_unit_size);
	printf("(13) ratecontrol_cpb_buffer_mode               = %d\n", 
			(int)appli_info->other_options_h264.avcbe_ratecontrol_cpb_buffer_mode);
	printf("(14) ratecontrol_cpb_max_size                  = %d\n", 
			(int)appli_info->other_options_h264.avcbe_ratecontrol_cpb_max_size);
	printf("(15) ratecontrol_cpb_offset                    = %d\n", 
			(int)appli_info->other_options_h264.avcbe_ratecontrol_cpb_offset);
	printf("(16) ratecontrol_cpb_offset_rate               = %d\n", 
			(int)appli_info->other_options_h264.avcbe_ratecontrol_cpb_offset_rate);
	...
	printf("(20) regularly_inserted_I_type                 = %d\n", 
			(int)appli_info->other_options_h264.avcbe_regularly_inserted_I_type);
	...
	printf("(25) slice_type_value_pattern                  = %d\n", 
			(int)appli_info->other_options_h264.avcbe_slice_type_value_pattern);
	printf("(26) use_mb_partition                          = %d\n", 
			(int)appli_info->other_options_h264.avcbe_use_mb_partition);
	printf("(27) mb_partition_vector_thr                   = %d\n", 
			(int)appli_info->other_options_h264.avcbe_mb_partition_vector_thr);
	...
	printf("(29) use_deblocking_filter_control             = %d\n", 
			(int)appli_info->other_options_h264.avcbe_use_deblocking_filter_control);
	printf("(30) deblocking_alpha_offset                   = %d\n", 
			(int)appli_info->other_options_h264.avcbe_deblocking_alpha_offset);
	printf("(31) deblocking_beta_offset                    = %d\n", 
			(int)appli_info->other_options_h264.avcbe_deblocking_beta_offset);
	...
	printf("(34) param_changeable                          = %d\n", 
			(int)appli_info->other_options_h264.avcbe_param_changeable);
	printf("(35) changeable_max_bitrate                    = %d\n", 
			(int)appli_info->other_options_h264.avcbe_changeable_max_bitrate);

	/* SequenceHeaderParameter */
	printf("(36) seq_param_set_id                          = %d\n", 
			(int)appli_info->other_options_h264.avcbe_seq_param_set_id);
	printf("(37) profile                                   = %d\n", 
			(int)appli_info->other_options_h264.avcbe_profile);
	printf("(38) constraint_set_flag                       = %d\n", 
			(int)appli_info->other_options_h264.avcbe_constraint_set_flag);
	...
	printf("(41) out_vui_parameters                        = %d\n", 
			(int)appli_info->other_options_h264.avcbe_out_vui_parameters);

	/* PictureHeaderParameter */
	printf("(42) chroma_qp_index_offset                    = %d\n", 
			(int)appli_info->other_options_h264.avcbe_chroma_qp_index_offset);
	printf("(43) constrained_intra_pred                    = %d\n", 
			(int)appli_info->other_options_h264.avcbe_constrained_intra_pred);
#endif
...
void cat_output_stream(APPLI_INFO *appli_info, avcbe_stream_info *context, 
					char *frame_stream_address, long frame_stream_size)
{
	...
	if ((appli_info->output_write_size +frame_stream_size) <= OUTPUT_BUF_SIZE) {
		memcpy((appli_info->output_buf +appli_info->output_write_size),
