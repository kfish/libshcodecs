/************************************************************************************
*																					*
*  SuperH MEPG-4 Video Driver Library												*
*																					*
*    Copyright (C) Renesas Technology Corp., 2004-2005. All rights reserved.		*
*																					*
*    Version  2.0 : m4iph_vpu4.h  2005/07/12 19:45  Renesas Technology Corp.		*
*																					*
************************************************************************************/
...
/* for decode */
long m4iph_vpu4_decode(M4IPH_VPU4_DEC *pDecOption, M4IPH_VPU4_DEC_RES *pDecResult, long int_off_continue);
...
/* for encode */
long m4iph_vpu4_encode(M4IPH_VPU4_ENC *pEncOption, M4IPH_VPU4_ENC_RES *pEncResult, long int_off_continue);
long m4iph_vpu4_enc_res(M4IPH_VPU4_ENC_RES *pEncResult);
long m4iph_vpu4_set_enc_default_param(long stream_type, M4IPH_VPU4_ENC *pEncOption,
...
void m4iph_reg_table_write(unsigned long *addr, unsigned long *table, long size);
unsigned long m4iph_reg_table_read(unsigned long *addr, unsigned long *table, long size);
unsigned long m4iph_sdr_read(unsigned char *address, unsigned char *buffer, unsigned long count);
void m4iph_sdr_write(unsigned char *address, unsigned char *buffer, unsigned long count);
